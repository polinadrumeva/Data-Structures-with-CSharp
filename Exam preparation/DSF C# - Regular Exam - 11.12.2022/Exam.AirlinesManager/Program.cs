...
namespace Exam.AirlinesManager
{
    public class Program
    {
        ...
        {
			var airlinesManager = new AirlinesManager();
			...
			List<Airline> list = airlinesManager.GetAirlinesOrderedByRatingThenByCountOfFlightsThenByName().ToList();
		}
    }
}
